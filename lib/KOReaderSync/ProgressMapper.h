 ...
 *
 * Borges tracks position as (spineIndex, pageNumber).
 * SavedProgress uses XPath-like strings + percentage.
 *
 * Since Borges discards HTML structure during parsing, we generate
...
class ProgressMapper {
 public:
   ...
   * server) directly to a Borges position, without XPath approximation.
