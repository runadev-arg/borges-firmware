/*
 * minibidi.c — Unicode Bidirectional Algorithm (UAX #9) for Borges/ESP32C3
 *
 ...
 *
 * Borges deviations from the upstream code, each marked inline:
 ...
 *      in its bidi_char array; in Borges they are real array entries
...
/* ── Borges extension: joining types outside U+0621–U+064A ──────────
...
/* ── Borges extension: presentation forms outside U+0621–U+064A ─────
...
/* Borges deviation 1: NSM marks (harakat) sit between letters in our
