...
// byte-level parts live in TotoNetBootCodec (host-tested).
...
// "https://highlights.runadev.com/x" -> "highlights.runadev.com" ("" if it does
...
// TotoPairingClient.cpp so pairing and sync share one scope.
