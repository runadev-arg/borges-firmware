...
bool CredentialStore::fromJson(JsonVariantConst doc) {
  ...
  baseUrl = stripTrailingSlashes(doc["baseUrl"] | "https://borges.runadev.com");
  if (baseUrl.rfind("https://", 0) != 0) {
    baseUrl = "https://borges.runadev.com";
    needsResave = true;
  }
  ...
  // Additive fields: absent in a pre-1.4.1-borges.8 file, which reads as "" and
