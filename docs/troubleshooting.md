...
1. Verify both devices are on the correct network
   ...
   - In **Join Network** mode, your computer/phone and Borges Reader must be on the same Wi-Fi network
   - In **Create Hotspot** mode, your computer/phone must be connected to the `Borges-Reader` hotspot
