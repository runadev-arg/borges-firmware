...
#include "network/BorgesWebServer.h"
...
/**
 * BorgesWebServerActivity is the entry point for file transfer functionality.
 * It:
 ...
 * - Starts the BorgesWebServer when connected
 * - Handles client requests in its loop() function
 * - Cleans up the server and shuts down WiFi on exit
 */
class BorgesWebServerActivity final : public Activity {
  ...
  std::unique_ptr<BorgesWebServer> webServer;
 ...
 public:
  explicit BorgesWebServerActivity(GfxRenderer& renderer, MappedInputManager& mappedInput)
      : Activity("BorgesWebServer", renderer, mappedInput) {}
