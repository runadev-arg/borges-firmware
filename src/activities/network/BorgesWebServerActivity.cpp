#include "BorgesWebServerActivity.h"
...
constexpr const char* AP_SSID = "Borges-Reader";
constexpr const char* AP_PASSWORD = nullptr;  // Open network for ease of use
constexpr const char* AP_HOSTNAME = "borges";
...
void BorgesWebServerActivity::onEnter() {
  Activity::onEnter();
...
void BorgesWebServerActivity::onExit() {
  Activity::onExit();
...
void BorgesWebServerActivity::onNetworkModeSelected(const NetworkMode mode) {
...
void BorgesWebServerActivity::onWifiSelectionComplete(const bool connected) {
...
void BorgesWebServerActivity::startAccessPoint() {
...
void BorgesWebServerActivity::startWebServer() {
...
void BorgesWebServerActivity::loop() {
...
void BorgesWebServerActivity::render(RenderLock&&) {
...
void BorgesWebServerActivity::renderServerRunning() const {
  const auto& metrics = UITheme::getInstance().getMetrics();
  const auto pageWidth = renderer.getScreenWidth();
...
void BorgesWebServerActivity::renderWifiIndicator(int subHeaderTop) const {
