...
UITheme::UITheme() {
  auto themeType = static_cast<BorgesSettings::UI_THEME>(SETTINGS.uiTheme);
  setTheme(themeType);
}
...
void UITheme::setTheme(BorgesSettings::UI_THEME type) {
  switch (type) {
    case BorgesSettings::UI_THEME::CLASSIC:
      LOG_DBG("UI", "Using Classic theme");
      currentTheme = std::make_unique<BaseTheme>();
      currentMetrics = &BaseMetrics::values;
      break;
    case BorgesSettings::UI_THEME::LYRA:
      LOG_DBG("UI", "Using Lyra theme");
      currentTheme = std::make_unique<LyraTheme>();
      currentMetrics = &LyraMetrics::values;
      break;
    case BorgesSettings::UI_THEME::ROUNDEDRAFF:
      LOG_DBG("UI", "Using RoundedRaff theme");
      currentTheme = std::make_unique<RoundedRaffTheme>();
      currentMetrics = &RoundedRaffMetrics::values;
      break;
    case BorgesSettings::UI_THEME::LYRA_3_COVERS:
