...
class BorgesState : public PersistableStore<BorgesState> {
  BorgesState() = default;

  friend class PersistableStore<BorgesState>;
 ...
 public:
  ...
  static const char* getFilePath() { return "/.borges/state.json"; }
...
#define APP_STATE BorgesState::getInstance()
