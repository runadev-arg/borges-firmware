...
bool BookmarkFile::load(const std::string& bookPath, std::vector<BookmarkEntry>& bookmarks) {
  ...
  for (JsonObject obj : arr) {
    ...
    bookmark.borgesSyncId = (obj["borges_id"].isNull() ? obj["toto_id"] : obj["borges_id"]) | "";
    bookmark.borgesNote = (obj["borges_note"].isNull() ? obj["toto_note"] : obj["borges_note"]) | "";
    bookmark.borgesFingerprint = (obj["borges_fp"].isNull() ? obj["toto_fp"] : obj["borges_fp"]) | "";
    bookmark.borgesPendingEventId = (obj["borges_event"].isNull() ? obj["toto_event"] : obj["borges_event"]) | "";
    bookmark.borgesRevision = (obj["borges_rev"].isNull() ? obj["toto_rev"] : obj["borges_rev"]) | static_cast<uint64_t>(0);
    bookmark.borgesPendingSequence = (obj["borges_seq"].isNull() ? obj["toto_seq"] : obj["borges_seq"]) | static_cast<uint64_t>(0);
    bookmark.borgesConflict = (obj["borges_conflict"].isNull() ? obj["toto_conflict"] : obj["borges_conflict"]) | false;
