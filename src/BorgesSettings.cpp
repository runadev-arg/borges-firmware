...
void BorgesSettings::validateFrontButtonMapping(BorgesSettings& settings) {
...
uint8_t BorgesSettings::sleepTimeoutEnumToMinutes(const uint8_t legacyValue) {
  switch (legacyValue) {
    case SLEEP_1_MIN:
      return 1;
    case SLEEP_5_MIN:
...
void BorgesSettings::toJson(JsonDocument& doc) const {
  const BorgesSettings& s = *this;
...
bool BorgesSettings::fromJson(JsonVariantConst doc) {
  BorgesSettings& s = *this;
...
BorgesSettings::StatusBarSpec BorgesSettings::statusBarSpec() const {
  StatusBarSpec spec;
...
ReaderRenderSpec BorgesSettings::readerRenderSpec(const uint16_t viewportWidth,
...
float BorgesSettings::getReaderLineCompression() const {
...
unsigned long BorgesSettings::getSleepTimeoutMs() const {
...
int BorgesSettings::getRefreshFrequency() const {
...
void BorgesSettings::clearSdFontFamily() {
...
int BorgesSettings::getReaderFontId() const {
